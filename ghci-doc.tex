...
Diagrams is a domain-specific language to draw vector graphics. It already has a \href{https://archives.haskell.org/projects.haskell.org/diagrams/doc/latex.html}{dedicated LaTeX package} that you might prefer to use rather than \texttt{ghci4luatex}.
